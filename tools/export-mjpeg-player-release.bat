...
set "VERSION=%~1"
set "REPO=%~dp0.."
set "SRC=%REPO%\firmware\MJPEG_VIDEO_PLAYER_ESP32_S3_LCD_1_47\build\esp32.esp32.esp32s3"
set "DST=%REPO%\firmware\MJPEG_VIDEO_PLAYER_ESP32_S3_LCD_1_47\release"
set "BASE=MJPEG_VIDEO_PLAYER_ESP32_S3_LCD_1_47"
...
if not exist "%APP_SRC%" (
  ...
  echo   %APP_SRC%
  echo.
  echo Run Arduino IDE: Sketch ^> Export Compiled Binary first.
  exit /b 3
)
