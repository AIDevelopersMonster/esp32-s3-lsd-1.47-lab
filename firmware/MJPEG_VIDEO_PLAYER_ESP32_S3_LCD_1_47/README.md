...
[Waveshare ESP32-S3-LCD-1.47 — аппаратная демонстрация MJPEG Video Player](https://youtube.com/shorts/Db57oCUU31w)

В ролике показана реальная работа порта на физической плате: автоматическое последовательное воспроизведение MJPEG с microSD и переход к следующему ролику кнопкой BOOT.
